    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tenant_met', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.tenant')),
            ],
        ),
        migrations.CreateModel(
            name='Document',
            fields=[
                ...
                ('listing', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='user.listing')),
                ('property_manager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.propertymanager')),
                ('tenant', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='user.tenant')),
            ],
        ),
        migrations.AddField(
